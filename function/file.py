class file:
    ...
    _hies_district = "data/population/Household Income Districts.parquet"

    # STR File
    _file_spm = "data/spm_initial/fix_Peka40STR2023.txt"
    _file_spm_parquet = "data/spm_initial/spm_full.parquet"
